 ...
 * @path: \vue-package-quickstart\src\entry\router\routes\index.ts
 */
...
function getStaticRoutes(): RouteRecordRaw[] {
  ...
  return [
    ...
    {
      name: 'potential',
      path: '/monitor/threat/potential',
      component: () => import('#/pages/PotentialPage.vue'),
      meta: {
        hideMenu: true,
        title: '潜在危害分析',
      },
    ...
    {
      name: 'Abnormal',
      path: '/monitor/threat/abnormal',
      component: () => import('#/pages/AbnormalPage.vue'),
      meta: {
        hideMenu: true,
        title: '异常行为分析',
      },
    ...
    {
      name: 'PeddingRelationEventsPage',
      path: '/monitor/threat/pedding-relation-events',
      component: () => import('#/pages/PeddingRelationEventsPage.vue'),
      meta: {
        hideMenu: true,
        title: '关联事件分析',
      },
