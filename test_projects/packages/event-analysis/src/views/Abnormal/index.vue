 ...
 * @author: bwb
 * @description: 异常行为分析
 * @path: \event-analysis\lib\views\Abnormal\index.vue
-->
<template>
  <div>
    <Form :model="form">
...
import { getEventStoreTreeApi } from '../../model/potential';
import { getAbnormalDataApi, getAbnormalBehaviorsEventNameApi } from "../../model/adnormal"
...
onMounted(() => {
  getEventTypeTree();
  query();
  getAbnormalBehaviorsEventNameApi().then(res => {
