...
<template>
  <div class="flex flex-shrink-0 items-center flex-col" :class="props.classes">
    <div class="flex items-center relative w-full rounded-6px text-[#28314d]">
      <input v-model.trim="value" class="w-full outline-0 text-[#1f2667] text-center font-bold text-12px"
        :maxlength="maxLen" :type="props.type" @focus="onFocus" @blur="onBlur" @input="onInput" />
    </div>
