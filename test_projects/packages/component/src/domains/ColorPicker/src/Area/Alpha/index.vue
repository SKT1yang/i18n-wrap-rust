...
-->
<template>
  <div class="relative w-full overflow-hidden rounded-10px h-14px cursor-pointer" @mousedown="mouseEvents">
...
import { getAlpha } from '@/domains/ColorPicker/src/helpers/index'
import { IColorState } from '@/domains/ColorPicker/src/types'
