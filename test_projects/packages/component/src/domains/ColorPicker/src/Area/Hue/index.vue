...
<template>
  <div class="relative w-full overflow-hidden rounded-10px mb-8px bg-[red] cursor-pointer" @mousedown="mouseEvents">
...
import { getHue } from '@/domains/ColorPicker/src/helpers'
