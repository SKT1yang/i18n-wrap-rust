...
<template>
  <div :class="`picker-pointer${activeClassName}`" :style="pointStyle" @mousedown.stop="mouseEvents"
    @dblclick.stop="removePoint" @click.stop="() => (colorPickerState.activePointIndex = props.index)">
...
import { useMouseEvents } from '@/domains/ColorPicker/src/hooks'
import { updateGradientActivePercent } from '@/domains/ColorPicker/src/helpers/index'
