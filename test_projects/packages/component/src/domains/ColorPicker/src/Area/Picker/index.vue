...
-->
<template>
  <div ref="pickerAreaRef" class="picker-area w-full mb-16px relative rounded-8px" :style="pickerStyle"
...
import { changePicker } from '@/domains/ColorPicker/src/helpers/index'
