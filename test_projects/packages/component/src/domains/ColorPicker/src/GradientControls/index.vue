...
-->
<template>
  <div class="gradient-controls border-box flex justify-between items-center w-full mb-8px px-16px">
    ...
    <div v-if="type === 'linear'" class="relative mr-24px">
      <div class="gradient-degrees cursor-pointer flex justify-center items-center" @mousedown="mouseEvents"
...
import { useMouseEvents } from '@/domains/ColorPicker/src/hooks/index'
import { calculateDegree } from '@/domains/ColorPicker/src/helpers/index'
import type { IColorState } from '@/domains/ColorPicker/src/types'
