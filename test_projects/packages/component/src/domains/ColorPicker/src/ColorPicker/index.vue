...
-->
<template>
  <div class="picker-color-ui border-box m-8px bg-[#fff] flex flex-col slelect-none">
    <Suspense>
      <template #default>
        <!-- 渐变 -->
    ...
    <div v-if="showBtn" class="btns flex justify-end items-center select-none">
      <div v-if="showCancel" class="btn" :style="{
...
import { generateSolidStyle, generateGradientStyle } from '@/domains/ColorPicker/src/helpers'
import { v4 as uuidv4 } from 'uuid'
import type { IColor, IColorState } from '@/domains/ColorPicker/src/types'
import { PropType } from 'vue'
import { defineAsyncComponent, reactive, provide } from 'vue';
