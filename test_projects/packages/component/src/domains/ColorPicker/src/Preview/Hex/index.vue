...
-->
<template>
  <CInput :value="hexValue" label="Hex" max-len="7" classes="hex mr-8px" @input="changeHex" />
</template>

<script name="PreviewHex" lang="ts" setup>
import { computed, inject } from 'vue';
import CInput from '@/domains/ColorPicker/src/CInput/index.vue'
import { rgbToHex, hexToRgb } from '@/domains/ColorPicker/src/helpers'
