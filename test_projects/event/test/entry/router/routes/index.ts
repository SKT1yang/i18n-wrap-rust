...
function getStaticRoutes(): RouteRecordRaw[] {
  ...
  return [
    ...
    },
    {
      ...
      path: '/audit/industrial',
      component: () => import('#/pages/IndustrialPage.vue'),
      meta: {
        title: '工控事件',
      },
    },
    {
      name: 'ItEvent',
      path: '/audit/it',
      component: () => import('#/pages/ItPage.vue'),
      meta: {
        title: 'IT事件',
      },
    },
    ...
    },
    {
      name: 'Attack',
      path: '/threat/attack',
      component: () => import('#/pages/AttackPage.vue'),
      meta: {
        title: '攻击事件',
      },
    },
    {
      name: 'ThreatIndusPage',
      path: '/threat/industrial',
      component: () => import('#/pages/ThreatIndusPage.vue'),
      meta: {
        title: '异常工控事件',
      },
    },
    ...
    {
      name: 'NetworkPage',
      path: '/policy/safety/associate',
      component: () => import('#/pages/AssociatePage.vue'),
      meta: {
        title: '关联事件配置',
      },
    },
